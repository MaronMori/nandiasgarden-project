...
def pizzas(request):
    number_of_pizzas = 2
    filld_multiple_pizza_form = MultiplePizzaForm(request.GET)
    if filld_multiple_pizza_form.is_valid():
        number_of_pizzas = filld_multiple_pizza_form.cleaned_data["number"]
